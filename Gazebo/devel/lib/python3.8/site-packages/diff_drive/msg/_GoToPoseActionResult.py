...
"""autogenerated by genpy from diff_drive/GoToPoseActionResult.msg. Do not edit."""
import sys
...
class GoToPoseActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "diff_drive/GoToPoseActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','diff_drive/GoToPoseResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToPoseActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = diff_drive.msg.GoToPoseResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = diff_drive.msg.GoToPoseResult()
