...
"""autogenerated by genpy from diff_drive/GoToPoseAction.msg. Do not edit."""
import sys
...
import diff_drive.msg
import genpy
import geometry_msgs.msg
import std_msgs.msg

class GoToPoseAction(genpy.Message):
  _md5sum = "a09032107a8150be51e1c2457bb25b44"
  _type = "diff_drive/GoToPoseAction"
...
"""
  ...
  _slot_types = ['diff_drive/GoToPoseActionGoal','diff_drive/GoToPoseActionResult','diff_drive/GoToPoseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToPoseAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = diff_drive.msg.GoToPoseActionGoal()
      if self.action_result is None:
        self.action_result = diff_drive.msg.GoToPoseActionResult()
      if self.action_feedback is None:
        self.action_feedback = diff_drive.msg.GoToPoseActionFeedback()
    else:
      self.action_goal = diff_drive.msg.GoToPoseActionGoal()
      self.action_result = diff_drive.msg.GoToPoseActionResult()
      self.action_feedback = diff_drive.msg.GoToPoseActionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.action_feedback.feedback.processing,) = _get_struct_B().unpack(str[start:end])
      self.action_feedback.feedback.processing = bool(self.action_feedback.feedback.processing)
      return self
