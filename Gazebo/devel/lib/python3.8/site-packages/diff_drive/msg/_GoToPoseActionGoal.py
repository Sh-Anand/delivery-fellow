...
"""autogenerated by genpy from diff_drive/GoToPoseActionGoal.msg. Do not edit."""
import sys
...
class GoToPoseActionGoal(genpy.Message):
  _md5sum = "0f976a59bdc328547eecdf07b04a9787"
  _type = "diff_drive/GoToPoseActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','diff_drive/GoToPoseGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GoToPoseActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = diff_drive.msg.GoToPoseGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = diff_drive.msg.GoToPoseGoal()
